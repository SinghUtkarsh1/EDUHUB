    ...
    <Box>
      ...
      >
        ...
        <Text
          ...
          fontWeight="semibold"
        >
          <Text fontSize='2rem' color="#0056d2" display='inline'>EDUHUB</Text> Where Educators and Students Connect Seamlessly Online. Teachers craft personalized courses for various subjects and grades, while students explore and purchase courses tailored to their needs. Empowering both educators and learners, EDUHUB revolutionizes online education.
        </Text>
        <Flex
          gap={30}
          direction={{
